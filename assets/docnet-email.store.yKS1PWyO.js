(function(){try{var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{};e.SENTRY_RELEASE={id:`4767a06c6c59269853c359b8421e84a6c1135dfb`};var t=new e.Error().stack;t&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[t]=`42dfe3c9-a56d-459c-8d6f-61f34bc2f6dd`,e._sentryDebugIdIdentifier=`sentry-dbid-42dfe3c9-a56d-459c-8d6f-61f34bc2f6dd`)}catch{}})();import{Xa as e,kt as t,vo as n,zd as r}from"./api-config.DocBcwP6.js";var i=class extends e{async fetchEmails(e){let t=await this.getHeaders(),r=new URLSearchParams({include_content:`false`});e?.read!==void 0&&r.set(`read`,String(e.read)),e?.skip!==void 0&&r.set(`skip`,String(e.skip)),e?.limit!==void 0&&r.set(`limit`,String(e.limit)),e?.search&&r.set(`search`,e.search);let i=await super.get(`${n.docnet_emails}?${r.toString()}`,{headers:t}),a=i;return{items:a.items||i,total:a.total??a.items?.length??0,skip:a.skip??e?.skip??0,limit:a.limit??e?.limit??50,unread_total:a.unread_total??0}}async fetchEmail(e){let t=await this.getHeaders();return await super.get(`${n.docnet_emails}/${e}?include_content=true`,{headers:t})}async patchEmail(e,t){let r=await this.getHeaders();return await super.patch(`${n.docnet_emails}/${e}`,t,{headers:r})}async markRead(e){let t=await this.getHeaders();await super.patch(`${n.docnet_emails}/${e}/read`,{},{headers:t})}async fetchExtractionResults(e){let t=await this.getHeaders();return await super.get(`${n.docnet_emails}/${e}/extraction-results`,{headers:t})}},a=[{id:`email-001`,org_id:`org-mock-001`,sender:`Klaus Bergmann`,email:`buchhaltung@rheinmuehle.de`,organization:`Rheinmühle GmbH`,subject:`Invoice RM-2026-4521 for PO #FB-4500123456`,body:`Dear Accounts Payable,
