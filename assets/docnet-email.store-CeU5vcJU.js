import{i as e}from"./vue-ecosystem-D1qosPQ9.js";import{Lr as t,g as n,ri as r}from"./main-CTAoMJgr.js";var i=class extends t{async fetchEmails(e){let t=await this.getHeaders(),n=new URLSearchParams({include_content:`false`});e?.read!==void 0&&n.set(`read`,String(e.read)),e?.skip!==void 0&&n.set(`skip`,String(e.skip)),e?.limit!==void 0&&n.set(`limit`,String(e.limit));let i=await super.get(`${r.docnet_emails}?${n.toString()}`,{headers:t}),a=i;return{items:a.items||i,total:a.total??a.items?.length??0,skip:a.skip??e?.skip??0,limit:a.limit??e?.limit??50,unread_total:a.unread_total??0}}async fetchEmail(e){let t=await this.getHeaders();return await super.get(`${r.docnet_emails}/${e}?include_content=true`,{headers:t})}async patchEmail(e,t){let n=await this.getHeaders();return await super.patch(`${r.docnet_emails}/${e}`,t,{headers:n})}async markRead(e){let t=await this.getHeaders();await super.patch(`${r.docnet_emails}/${e}/read`,{},{headers:t})}},a=[{id:`email-001`,org_id:`org-mock-001`,sender:`Klaus Bergmann`,email:`buchhaltung@rheinmuehle.de`,organization:`Rheinmühle GmbH`,subject:`Invoice RM-2026-4521 for PO #FB-4500123456`,body:`Dear Accounts Payable,
...
Batch ready for release. Allergens: May contain MILK traces (shared facility).`,date:`2026-03-08T16:00:00Z`,message_id:`<msg-003@cacaotropicale.ec>`,to:`quality@docbits.com`,cc:null,reply_to:null,in_reply_to:null,references:null,classification:`CoA`,read:!0,mission_id:null,orchestration_status:`done`,created_on:`2026-03-08T16:00:00Z`,last_modified_on:null}],o=new i,s=e(`docnet_email`,{state:()=>({emails:[],selectedEmailId:null,loading:!1,page:1,limit:50,total:0,unreadTotal:0,_lastFetchParams:void 0}),getters:{unreadCount(e){return e.unreadTotal},emailsByMission:e=>t=>e.emails.filter(e=>e.mission_id===t),emailsByClassification:e=>t=>e.emails.filter(e=>e.classification===t),selectedEmail(e){return e.selectedEmailId?e.emails.find(t=>t.id===e.selectedEmailId)??null:null},totalPages(e){return Math.max(1,Math.ceil(e.total/e.limit))}},actions:{async fetchEmails(e){if(n().useMockData){this.emails=a,this.total=a.length;return}let t=e?.read??(e===void 0?this._lastFetchParams?.read:void 0),r=t===this._lastFetchParams?.read,i=(e?.page??this.page)===this.page,s=this.emails.length>0&&r&&i;s||(this.loading=!0);try{let n=e?.page??this.page,r=(n-1)*this.limit,i=await o.fetchEmails({read:t,skip:r,limit:this.limit});s?this._mergeEmails(i.items):this.emails=i.items,this.total=i.total,this.unreadTotal=i.unread_total,this.page=n,this._lastFetchParams={read:t}}finally{this.loading=!1}},async goToPage(e,t){await this.fetchEmails({...t,page:e})},async fetchEmailDetail(e){let t=await o.fetchEmail(e),n=this.emails.findIndex(t=>t.id===e);return n!==-1&&(this.emails[n]=t),t},async markAsRead(e){let t=this.emails.find(t=>t.id===e);t&&!t.read&&(t.read=!0,this.unreadTotal>0&&this.unreadTotal--),await o.markRead(e)},async linkToMission(e,t){await o.patchEmail(e,{mission_id:t});let n=this.emails.find(t=>t.id===e);n&&(n.mission_id=t)},async setOrchestrationStatus(e,t){await o.patchEmail(e,{orchestration_status:t});let n=this.emails.find(t=>t.id===e);n&&(n.orchestration_status=t)},resetPagination(){this.page=1,this.total=0,this.emails=[]},_mergeEmails(e){let t=new Map(this.emails.map(e=>[e.id,e]));for(let n of e){let e=t.get(n.id);e&&Object.assign(e,n)}let n=e.filter(e=>!t.has(e.id));n.length>0&&this.emails.unshift(...n)}}});export{s as t};