(function(){try{var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{};e.SENTRY_RELEASE={id:`c0ada378f789d7ef842a2804316b2a97db190ede`};var t=new e.Error().stack;t&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[t]=`d5e1d00e-f1a4-4f81-995c-619e6d3cb157`,e._sentryDebugIdIdentifier=`sentry-dbid-d5e1d00e-f1a4-4f81-995c-619e6d3cb157`)}catch{}})();import{Ed as e,Ka as t,kt as n,mo as r}from"./api-config.BfdeiD6t.js";var i=class extends t{async fetchEmails(e){let t=await this.getHeaders(),n=new URLSearchParams({include_content:`false`});e?.read!==void 0&&n.set(`read`,String(e.read)),e?.skip!==void 0&&n.set(`skip`,String(e.skip)),e?.limit!==void 0&&n.set(`limit`,String(e.limit)),e?.search&&n.set(`search`,e.search);let i=await super.get(`${r.docnet_emails}?${n.toString()}`,{headers:t}),a=i;return{items:a.items||i,total:a.total??a.items?.length??0,skip:a.skip??e?.skip??0,limit:a.limit??e?.limit??50,unread_total:a.unread_total??0}}async fetchEmail(e){let t=await this.getHeaders();return await super.get(`${r.docnet_emails}/${e}?include_content=true`,{headers:t})}async patchEmail(e,t){let n=await this.getHeaders();return await super.patch(`${r.docnet_emails}/${e}`,t,{headers:n})}async markRead(e){let t=await this.getHeaders();await super.patch(`${r.docnet_emails}/${e}/read`,{},{headers:t})}async fetchExtractionResults(e){let t=await this.getHeaders();return await super.get(`${r.docnet_emails}/${e}/extraction-results`,{headers:t})}},a=[{id:`email-001`,org_id:`org-mock-001`,sender:`Klaus Bergmann`,email:`buchhaltung@rheinmuehle.de`,organization:`Rheinmühle GmbH`,subject:`Invoice RM-2026-4521 for PO #FB-4500123456`,body:`Dear Accounts Payable,
